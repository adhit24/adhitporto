Build a 3D Creator portfolio landing page for "Adhit" using React, TypeScript, Tailwind CSS, Framer Motion, and Lucide React. The page has a dark theme (#0C0C0C background) with the font Kanit (Google Fonts, weights 300-900). The page title is "Adhit -- Coffeeshop Entrepreneur, Website Designer & CRM Specialist ".
